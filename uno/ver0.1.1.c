...
int main(){
    ...
    printf("\n\n");
    processPlus(1, playerCards, 2, amounts);
    interpreter(playerCards, amounts[0], 1000);
    printf("\n\n");
    printf("%d\n", amounts[0]);


    /*testing to see if plus four and plus two work*/
    /*printf("%d\n\n\n\n", amounts[0]);
    processPlus(1, playerCards, 2, amounts);
    printf("UWUUWUWUWUWU\n");
    printf("%d", amounts[0]);
    interpreter(playerCards, amounts[0], 8);
    interpreter(playerCards, amounts[0], 9);
    interpreter(playerCards, amounts[0], 0);
    interpreter(playerCards, amounts[0], 1);*/
}
